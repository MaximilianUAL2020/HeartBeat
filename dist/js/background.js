...
__webpack_require__.g.cow = "mooh"; // 1. Run interval in the background script
// 2. Option 1 -> Send message to popup when active
// 3. Option 2 -> Update storage value and pull in from popup
// Functionality
// 1. Create a countdown that keeps running when the popup isn't active
// 2. Toggle (Pause/Play) the extension on and off
// 3. Reset the counter of the extension
